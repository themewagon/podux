                    ...
                    <div class="pt-8 lg:pt-10 w-max mx-auto lg:mx-0">
                        <div class="flex items-center text-center flex-col sm:flex-row gap-4 sm:gap-0">
                            <div class="flex items-center">
                                <img :src="useAssetUrl('/images/sidebiew.webp')" width="40" alt="avatar"
                ...
                <div class="lg:h-full  hidden md:flex">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img :src="useAssetUrl('/images/sidebiew.webp')" alt="In studio" width="500" height="auto" loading="lazy"
                        ...
                        <div
                            ...
                            <img :src="useAssetUrl('/images/sidebiew.webp')" alt="Happy in studio" width="200" height="auto"
