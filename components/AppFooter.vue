                ...
                <div class="flex justify-between items-center gap-5 text-gray-600 dark:text-gray-300">
                    <div class="">
                        &copy; {{ new Date().getFullYear() }} Allright Reserved. Designed by <NuxtLink target="_blank"
                            to="https://github.com/Johnkat-Mj" class="font-bold text-primary">Kat Mj</NuxtLink>
                             • Distributed by <NuxtLink target="_blank"
                            to="https://themewagon.com" class="font-bold text-primary">ThemeWagon</NuxtLink>
                    </div>
